...
opTests =
  ...
  , (ladd $ list [Number 1, Float 1.5], Float 2.5)
  , (lsub $ numList [5, 3], Number 2)
  , (lsub $ list [Float 3.5, Float 0.25], Float 3.25)
  , (lmul $ numList [1, 2, 3, 4], Number 24)
  , (lmul $ list [Number 1, Float 1.5], Float 1.5)
  , (ldiv $ numList [55, 11], Number 5)
  , (ldiv $ list [Float 5.5, Number 2], Float 2.75)
